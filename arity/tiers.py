"""arity tiers — Distance-from-Asa memory tiers, brief compilation, and identity.
...
class BriefCompiler:
    ...
    def __init__(
        ...
        tier1_context: str = "Project arity: Composable statechart agent chassis with 5 explicit seams.",

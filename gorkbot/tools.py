"""gorkbot tools — Sandbox tool runner, AST syntax validation, and MCP adapter.
...
def get_config_value(key: str) -> Optional[str]:
    """Resolve configuration value from environment or .gorkbot/config.json."""
...
class McpToolAdapter(ToolRunner):
    """Adapts external Model Context Protocol (MCP) tool servers into gorkbot ToolRunner."""

...
* **What I was trying to do:** Deliver a zero-dependency Python 3.13 reference implementation of the entire gorkbot protocol—coordinating multi-model kernels with strict role denial sets, brief refusal traps, real HTTP harnesses, presence-aware seat casting, archivist fraud audits, bounded redphone handoffs, and economic keepalive pulsing under 1,500 lines.

"""gorkbot tasks — A bank of race tasks: a brief the builders see, hidden tests they don't.
...
Project-local banks in `.gorkbot/tasks/` and `~/.gorkbot/tasks/` override the packaged one by name.
"""
